...
class INET_API IPvXAddressResolver
{
  ...
  public:
    ...
    /**
     * The function tries to look up the CommunicationUnit module as submodule
     * <tt>"notificationBoard"</tt> within the host/router module. Throws an error
     * if not found.
     */
    virtual CommunicationUnit *notificationBoardOf(cModule *host);
     ...
     */
    virtual CommunicationUnit *findCommunicationUnitOf(cModule *host);
