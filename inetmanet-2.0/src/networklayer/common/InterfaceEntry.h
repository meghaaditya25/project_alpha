...
class ieee80211acInterfaceData;
...
class INET_API InterfaceEntry : public cNamedObject
{
  ...
  protected:
    ...
    ieee80211acInterfaceData * ieee8021ddata;
  ...
  public:
    ...
    ieee80211acInterfaceData *ieee8021dData() const {return ieee8021ddata;}
    //@}
    ...
    virtual void setieee80211acInterfaceData(ieee80211acInterfaceData *p);
    //@}
