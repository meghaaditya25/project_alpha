...
/* Constructor for the AODV routing agent */

bool AODV::log_file_fd_init=false;
int AODV::log_file_fd = -1;

#ifdef AODV_GLOBAL_STATISTISTIC
bool AODV::iswrite = false;
int AODV::totalSend=0;
int AODV::totalRreqSend=0;
int AODV::totalRreqRec=0;
int AODV::totalRrepSend=0;
int AODV::totalRrepRec=0;
int AODV::totalRrepAckSend=0;
int AODV::totalRrepAckRec=0;
int AODV::totalRerrSend=0;
int AODV::totalRerrRec=0;
int AODV::totalLocalRep =0;
#endif
std::map<ManetAddress,u_int32_t *> AODV::mapSeqNum;
...
void NS_CLASS recvAODVPacket(cMessage * msg)
{
...
bool AODV::getDestAddressRreq(cPacket *msg,PacketDestOrigin &orgDest,RREQInfo &rreqInfo)
{
    RREQ *rreq = dynamic_cast <RREQ *>(msg);
    if (!rreq)
        return false;
