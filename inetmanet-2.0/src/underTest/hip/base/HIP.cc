...
void HIP::initialize()
{
    ...
    nb->subscribe(this, NF_L2_DISASSOCIATED); // NF_L2_DATA_LOST
...
// Changes in interface states and addresses handled here with the help of the CommunicationUnit object
