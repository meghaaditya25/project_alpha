...
/**
 * Category constants for CommunicationUnit
 */
...
enum
{
    ...
    NF_L2_Q_DROP,
    NF_MAC_BECAME_IDLE,
    NF_L2_DATA_LOST,   // missed several consecutive beacons (currently Ieee80211)
    ...
    NF_L2_DISASSOCIATED,  // same as DATA_LOST but used in higher layers
