 ...
 * access to the CommunicationUnit module.
 *
...
class INET_API BasicModule: public cSimpleModule, public INotifiable
{
  ...
  protected:
     ...
     * categories at CommunicationUnit. The first notifications
    ...
    /**
     * @brief Called by the CommunicationUnit whenever a change of a category occurs
