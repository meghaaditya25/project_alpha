...
#ifndef ieee80211acRelay_H_
#define ieee80211acRelay_H_
...
//
class INET_API ieee80211acRelay : public cSimpleModule, public ILifecycle
{
    public:
        ieee80211acRelay();
    ...
    protected:
         ...
         */
        ieee80211acInterfaceData * getPortInterfaceData(unsigned int portNum);
