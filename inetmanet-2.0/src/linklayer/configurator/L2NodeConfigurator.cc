...
void L2NodeConfigurator::prepareInterface(InterfaceEntry * interfaceEntry)
{
    ...
    ieee80211acInterfaceData * ieee80211acInterfaceDataobj = new ieee80211acInterfaceData();
    interfaceEntry->setieee80211acInterfaceData(ieee80211acInterfaceDataobj);
}
