...
#ifndef INET_ieee80211acInterfaceData_H_
#define INET_ieee80211acInterfaceData_H_
 ...
 */
class ieee80211acInterfaceData : public InterfaceProtocolData
{
    public:

        ieee80211acInterfaceData();
