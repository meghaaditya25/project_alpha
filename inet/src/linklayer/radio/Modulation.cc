...
double QAMModulation::calculateBER(double snir, double bandwidth, double bitrate)
{
    return 0.5 * (1 - 1 / sqrt(pow(2.0, 4))) * erfc(snir * bandwidth / bitrate);
}

double QPSKModulation::calculateBER(double snir, double bandwidth, double bitrate)
{
