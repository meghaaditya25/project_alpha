...
void Ieee80211Mesh::startEtx()
{
    ...
    ETXProcess = dynamic_cast <Ieee80211p*> (module);
...
void Ieee80211Mesh::handleMessage(cMessage *msg)
{
    ...
    else if(strstr(msg->getName() ,"Data")!=NULL ){sendOrEnqueue(PK(msg));}
    else if(   strstr(msg->getName() ,"Data")!=NULL
...
void Ieee80211Mesh::handleBeaconFrame(Ieee80211BeaconFrame *frame)
{
    ...
    EV << "Data from MAC, send it to SecurityModule" << frame << endl;
    send(frame, "securityOut");
}
