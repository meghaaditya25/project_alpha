...
// out vectors
  ...
  protected:
     ...
     * will wait EIFS - Attacker_Detection + AIFS  instead of AIFS period of time in WAITAIFS state.
     */
  ...
  protected:
    ...
    cMessage *endAttacker_Detection;
...
//    cMessage *endAIFS[4];
  ...
  protected:
     ...
     */
    //@{
    /** @brief Called by the CommunicationUnit whenever a change occurs we're interested in */
  ...
  protected:
    ...
    virtual simtime_t getAttacker_Detection();
  ...
  protected:
    ...
    virtual void scheduleAttacker_DetectionPeriod();
    virtual void cancelAttacker_DetectionPeriod();
