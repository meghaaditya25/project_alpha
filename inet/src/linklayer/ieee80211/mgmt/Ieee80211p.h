...
#ifndef IEEE80211_P_ADHOC_H
#define IEEE80211_P_ADHOC_H
...
class INET_API Ieee80211p : public cSimpleModule, public MacEstimateCostProcess, public INotifiable
{
    enum CostTypes
    {
        ETT,
