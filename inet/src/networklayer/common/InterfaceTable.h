 ...
 * the following notifications in CommunicationUnit: NF_INTERFACE_CREATED,
...
class INET_API InterfaceTable : public cSimpleModule, public IInterfaceTable, protected INotifiable, public ILifecycle
{
  protected:
    ...
    CommunicationUnit *nb; // cached pointer
  ...
  public:
    /**
     * Called by the CommunicationUnit whenever a change of a category
