...
void TraCIMobility::initialize(int stage)
{
    ...
    if (stage == 0)
    {
        ...
        currentPosXVec.setName("new_vehicle_posx");
        currentPosYVec.setName("new_vehicle_posy");
        currentSpeedVec.setName("speed");
        currentAccelerationVec.setName("delay_communication");
        currentCO2EmissionVec.setName("packets_communications_Between_V2V_&_V2I");
