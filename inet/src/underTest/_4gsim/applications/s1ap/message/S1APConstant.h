...
enum ProcedureCodeValues {
	id_Attacker_DetectionPreparation						= 0,
	id_Attacker_DetectionResourceAllocation 				= 1,
	id_Attacker_DetectionNotification 					= 2,
	id_PathSwitchRequest 						= 3,
	id_Attacker_DetectionCancel 							= 4,
	id_E_RABSetup								= 5,
	id_E_RABModify 								= 6,
	id_E_RABRelease								= 7,
...
enum ProtocolIeIds {
	...
	id_Attacker_DetectionRestrictionList							= 41,
	id_UEPagingID 										= 43,
	id_pagingDRX 										= 44,
	id_TAIList											= 46,
	id_TAIItem											= 47,
